$().ready(function(){
	...
	$(".openapp").click(function(){
		...
		var kid = obj.attr("kid");
		var keyword = obj.attr("keyword");
		ymPrompt.win({message:path+'/openapp?id='+kid,width:600,height:400,title:'开通【'+keyword+'】APP',handler:callBack,iframe:true})
	});
	$(".xufei").click(function(){
		var obj = $(this);
		var kid = obj.attr("kid");
		var keyword = obj.attr("keyword");
		ymPrompt.win({message:path+'/xufei?id='+kid,width:600,height:400,title:'当前为【'+keyword+'】进行续费操作',handler:callBack,iframe:true})
	});
});
