...
$().ready(function(){
	...
	$("#addcontact").click(function(){
		var str = $("<tr><td><input type='text' style='width:130px;' name='constants["+contactcount+"].contactName'/><span style='color:red;'>*</span></td>"+
					"<td><input type='text' style='width:130px;' name='constants["+contactcount+"].contactTel'/><span style='color:red;'>*</span></td>"+
					"<td><input type='text' style='width:130px;' name='constants["+contactcount+"].contactFax'/></td>"+
					"<td><input type='text' style='width:130px;' name='constants["+contactcount+"].contactEmail'/></td>"+
					"<td><input type='text' style='width:130px;' name='constants["+contactcount+"].contactRole'/></td>"+
