...
<div class="mbxnav">
	<a href="javascript:void(0);">系统管理</a> \ <a href="${pageContext.request.contextPath }/caiwu">财务管理</a>
</div>
<div class="container">
<div class="searchuserdiv">
<div>搜索用户：<input id="searchUerText" type="text" /> 输入后自动搜索
...
<div class="searchuserdiv ope">
	<ul>
		...
		<select id="zijintype">
			...
			<c:forEach items="${accountConfigList }" var="systemconfig">
