...
public class Keywords extends Base {
	...
	/*
	 * create table CREATE TABLE `as_keywords` ( `id` bigint(20) unsigned NOT NULL
	 * AUTO_INCREMENT, `keywords` varchar(100) NOT NULL, `agentId` bigint(20) NOT
	 * NULL, `agentName` varchar(255) NOT NULL, `customId` bigint(20) NOT NULL,
	 * `customName` varchar(255) NOT NULL, `preRegFrozenMoney` double NOT NULL
	 * DEFAULT '0', `price` double NOT NULL DEFAULT '0', `productType` int(11)
	 * DEFAULT '0', `serviceYears` int(11) DEFAULT '0' COMMENT '服务年限', `openApp`
	 * int(11) DEFAULT '0' COMMENT '0未开通 1 开通', `appUserName` varchar(64) DEFAULT
	 * NULL, `appPassword` varchar(70) DEFAULT NULL, `loginUrl` varchar(255) DEFAULT
	 * NULL COMMENT '登陆地址', `iosDownloadUrl` varchar(255) DEFAULT NULL COMMENT
	 * 'ios客户端下载地址', `androidDownloadUrl` varchar(255) DEFAULT NULL COMMENT
	 * 'android客户端下载地址', `codeIosUrl` varchar(255) DEFAULT NULL COMMENT
	 * 'IOS二维码下载地址', `codeAndroidUrl` varchar(255) DEFAULT NULL COMMENT
	 * 'android二维码下载地址', `preRegDatetime` datetime DEFAULT '2012-01-01 00:01:01',
	 * `preRegPassDatetime` datetime DEFAULT '2012-01-01 00:01:01', `regDatetime`
	 * datetime DEFAULT '2012-01-01 00:01:01', `regPassDatetime` datetime DEFAULT
	 * '2012-01-01 00:01:01', `isPass` int(11) DEFAULT '0' COMMENT
	 * '0为不过期，1为预注册过期，2为正式注册过期', `checkStatus` int(11) DEFAULT '0' COMMENT '0为已申请
	 * 1为审核中 2为已通过 3未通过', `isUse` int(11) DEFAULT '0' COMMENT '1为已使用 0为未使用', PRIMARY
